    ...
    if(providertrue!.isios)
      {
        ...
        const Center(child: Text('No Any Chats Yets....')): Column(
                  ...
                  return AlertDialog(
                      ...
                      children: [
                        providertrue!.callList[detailsindex].img == null
                          ...
                          AssetImage('asset/img/camera.png'),
                            ...
                            : CircleAvatar(
                          backgroundImage:
                          FileImage(providertrue!.callList[detailsindex].img!),
                        ),
                    ...
                    actions: [
                      Row(
                        ...
                        children: [
                          InkWell(child: const Icon(CupertinoIcons.pen), onTap: () {
                            providerfalse!.editdetails(detailsIndex:  detailsindex);
                      ...
                      InkWell(child: const Text('Cancel'), onTap: () {
                        Navigator.of(context).pop();
                      },)
                    ],
                  );
                      ...
                      return CupertinoAlertDialog(
                        ...
                        actions: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              CupertinoButton(child: const Icon(CupertinoIcons.pen), onPressed: () {
                                providerfalse!.editdetails(detailsIndex: detailsindex);
                                Navigator.of(context).pop();
                              },),
